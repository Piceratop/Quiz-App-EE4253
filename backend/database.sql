...
('Which of the following is a valid MySQL data type for storing a date?', 'MCQ', 'TIMESTAMP', JSON_ARRAY('TIMESTAMP', 'DATE', 'DATETIME'), 0),
...
('True of False: The MySQL function is used to return the current date and time is called CURRENT_TIME().', 'MCQ', 'False', JSON_ARRAY('True', 'False'), 0),
