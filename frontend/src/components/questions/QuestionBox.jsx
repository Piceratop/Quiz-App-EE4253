...
function MulipleChoiceBox({ correctAnswers, possibleAnswers }) {
   return <>Multiple Choice Box</>;
}
...
export default function QuestionBox({
   ...
   console.log(question, correctAnswers, possibleAnswers, shuffle, type);
         ...
         <div className="my-2 border-primary border-2 transition duration-400 ease-in-out">
            <div className="border-b border-primary">
               <div className="text-sm px-1">
                  Question Type: {type === "MCQ" ? "Multiple Choice" : ""}
               </div>
            </div>
